...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Make request to backend using Node.js fetch
        ...
        console.log(`[AUTH PROXY] Backend response:`, responseText);
        ...
        try {
            ...
            console.log(`[AUTH PROXY] Failed to parse JSON, sending as text`);
